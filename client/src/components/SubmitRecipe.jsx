...
function SubmitRecipe() {
  ...
  function handleCocktailChange(e) {
    setCocktailForm({ ...cocktailForm, [e.target.name]: e.target.value });
  }
  return (
    <Container>
      {" "}
      <button className="formSwitch" onClick={handleSwitch}>
        {whichForm ? "Show Cocktail Form" : "Show Recipe Form"}
      </button>{" "}
      {whichForm ? (
        <>
          {" "}
                ...
                {cocktailForm["alcohol_type"].map((type, index) => (
                  <li key={index}>
                    ...
                    <input
                      ...
                      value={type}
                      onChange={(e) => {
                        const updatedAlcoholTypes = [
                          ...cocktailForm["alcohol_type"],
                        ];
